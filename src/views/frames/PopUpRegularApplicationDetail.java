...
public class PopUpRegularApplicationDetail extends VBox{
	
	
	private final Label applicationDetailLabel, jobNameLabel, applicantNameLabel, applicantPhoneLabel, applicantEmailLabel, cvDescLabel, transcriptDescLabel, cvDescTitleLabel, transcriptDescTitleLabel;
	...
	public PopUpRegularApplicationDetail(String jobName, String applicantName, String applicantPhone,  String applicantEmail, String cvDesc, String transcriptDesc) {
		this.jobNameLabel = new Label("Applying as: "+jobName);
	...
	public void setElements() {
		...
		this.getChildren().addAll(applicationDetailLabel, separator, jobNameLabel, applicantNameLabel, applicantPhoneLabel, cvField, closeButton);
