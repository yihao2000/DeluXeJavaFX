...
public class PopUpAllApplicationListItem extends HBox{
	...
	public PopUpAllApplicationListItem(String jobName, double jobSalary, String jobDesc, Timestamp cvApplicationDate) {
	...
	public void setElements() {
		...
		this.setMinWidth(588);
		this.setSpacing(290);
		
		applicationDetailContainer.setMinWidth(300);
		applicationDetailContainer.setMaxWidth(300);
