...
public class PopUpAllWishListItems extends HBox{
...
public PopUpAllWishListItems(String jobName, double jobSalary, String jobDesc) {
...
public void setElements() {
	...
	jobDetailContainer.setMinWidth(300);
	jobDetailContainer.setMaxWidth(300);
