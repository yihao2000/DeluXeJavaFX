...
public class PopUpStudentReportDetail extends VBox{
	
	private final Label youAreApplyingLabel, jobNameLabel, jobDescriptionLabel,  applicationDateLabel, cvDescLabel, transcriptDescLabel;
	...
	public PopUpStudentReportDetail(String jobName, String jobDesc,Timestamp applicationDate, String cvDesc, String transcriptDesc) {
	...
	public void setElements() {
		...
		this.getChildren().addAll(youAreApplyingLabel, jobNameLabel, jobDescriptionLabel,  separator, cvField, closeButton);
